    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#0a0a0b', color: '#e4e4e7', fontFamily: "'IBM Plex Sans', -apple-system, sans-serif", padding: '32px' }}>
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        <div style={{ marginBottom: '40px' }}>
          ...
          <p style={{ color: '#71717a', margin: 0, fontSize: '14px' }}>Select a macro, paste Gorgias ticket (Ctrl+A), get a personalized response • Product knowledge: 12 products • 58 macros</p>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr 1fr', gap: '24px' }}>
          ...
          <div style={{ backgroundColor: '#18181b', borderRadius: '12px', border: '1px solid #27272a', padding: '20px', display: 'flex', flexDirection: 'column' }}>
            ...
            <textarea value={ticketContent} onChange={e => setTicketContent(e.target.value)} placeholder="Paste the entire Gorgias ticket content here..." style={{ width: '100%', flex: 1, minHeight: '200px', padding: '12px', backgroundColor: '#0a0a0b', border: '1px solid #3f3f46', borderRadius: '8px', color: '#e4e4e7', fontSize: '14px', lineHeight: '1.5', resize: 'none', outline: 'none' }} />
            <div style={{ marginTop: '16px' }}>
              ...
              <textarea value={additionalNotes} onChange={e => setAdditionalNotes(e.target.value)} placeholder="Add any extra info: specific offers, tracking links, special instructions..." style={{ width: '100%', height: '100px', padding: '12px', backgroundColor: '#0a0a0b', border: '1px solid #3f3f46', borderRadius: '8px', color: '#e4e4e7', fontSize: '14px', lineHeight: '1.5', resize: 'vertical', outline: 'none' }} />
            </div>
